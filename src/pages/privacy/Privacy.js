function Privacy() {
  return (
    <div>
      <h1>Privacy Policy for Teriot</h1>

      <p>
        At Teriot, one of our main priorities is the privacy of our visitors.
        This Privacy Policy document contains types of information that is
        collected and recorded by Teriot and how we use it.
      </p>
      ...
      <p>
        Teriot follows a standard procedure of using log files. These files log
      ...
      <p>
        ...
        advertising partners of Teriot.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Beacons that are used in their respective advertisements
        and links that appear on Teriot. They automatically receive your IP
      ...
      <p>
        Note that Teriot has no access to or control over these cookies that are
      ...
      <p>
        Teriot's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Teriot does not knowingly collect any Personal Identifiable Information
        from children under the age of 13. If you think that your child provided
        this kind of information on our App, we strongly encourage you to
