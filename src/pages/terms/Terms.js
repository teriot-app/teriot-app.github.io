  ...
  return (
    <>
      ...
      <p>
        ...
        not continue to use Teriot if you do not agree to take all of the terms
      ...
      <p>
        Unless otherwise stated, Teriot and/or its licensors own the
        intellectual property rights for all material on Teriot. All
        intellectual property rights are reserved. You may access this from
        Teriot for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Teriot</li>
        <li>Sell, rent or sub-license material from Teriot</li>
        <li>Reproduce, duplicate or copy material from Teriot</li>
        <li>Redistribute content from Teriot</li>
      </ul>
      ...
      <p>
        ...
        opinions and information in certain areas of the website. Teriot does
        not filter, edit, publish or review Comments prior to their presence on
        the website. Comments do not reflect the views and opinions of Teriot,
        ...
        applicable laws, Teriot shall not be liable for the Comments or for any
      ...
      <p>
        Teriot reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Teriot a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Teriot; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Teriot. Please include your name, your organization name,
      ...
      <p>
        No use of Teriot's logo or other artwork will be allowed for linking
